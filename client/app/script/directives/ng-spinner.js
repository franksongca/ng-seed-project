...
angular.module('ngSeedApp').directive('ngSpinner', [
    ...
    return {
        ...
        link: function (scope, element, attr) {
            var spinnerHtml = '<div style="position: relative;margin-top:{marginTop};" class="sk-spinner-container sk-spinner-container-small"><div></div><div style="width:{size}px !important;height:{size}px !important; left:calc(50% - {halfSize}px) !important;" class="sk-spinner sk-spinner-circle"><div class="sk-circle1 sk-circle"></div><div class="sk-circle2 sk-circle"></div><div class="sk-circle3 sk-circle"></div><div class="sk-circle4 sk-circle"></div><div class="sk-circle5 sk-circle"></div><div class="sk-circle6 sk-circle"></div><div class="sk-circle7 sk-circle"></div><div class="sk-circle8 sk-circle"></div><div class="sk-circle9 sk-circle"></div><div class="sk-circle10 sk-circle"></div><div class="message"></div></div></div>',//'<img src="assets/images/spinner.gif" style="margin-top:{marginTop}px;" width={size} height={size}>',
                height,
                feedId = attr.feedId,
                aniSize = 60,
                halfSize,
